...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_GRV,    KC_Z,        KC_X,        KC_C,         KC_V,      KC_B,        KC_N,    KC_M,        KC_COMM,      KC_DOT,        KC_SLSH,    KC_QUOT,
                                        KC_BSLS,       MO(1),   KC_SPC,        KC_ENT,  MO(2),       KC_BSPC
  ),
  ...
  [_LOWER] = LAYOUT_split_3x6_3(
    ...
    XXXXXXX,  XXXXXXX,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                        _______, _______,   KC_SPC,        KC_ENT, _______,  KC_DEL
  ),
  ...
  [_ADJUST] = LAYOUT_split_3x6_3(
        RESET, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC,                      KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, KC_LCBR,                      KC_RCBR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                          _______, _______,   KC_SPC,        KC_ENT,  _______, _______
  )
};
